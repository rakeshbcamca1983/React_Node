                        ...
                        <div className="column is-4-desktop">
                            <form onSubmit={Register} className="box">
                                ...
                                <div className="field mt-5">
                                    ...
                                    <div className="controls">
                                        <input type="password" required className="input" placeholder="******" value={confPassword} onChange={(e) => setConfPassword(e.target.value)} />
                                    </div>
                                </div>
                                <div className="field mt-5">
                                    <button className="button is-success is-fullwidth">Register</button>
                                </div>
                            <a href="/" className="button is-info is-fullwidth">
                            Log in
                        </a>
                            </form>
                        </div>
